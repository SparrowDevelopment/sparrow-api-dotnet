    ...
    public partial class SampleGenerator
    {
        public async Task Generate()
        {
            ...
            var result_AdvancedECheck = await _sparrow_ach.AdvancedECheck(""sale"", ""First Test Bank"", ""110000000"", ""1234567890123"", ""checking"", ""personal"", 9.99m, 
                ...
                Log(SparrowResponseSamples.ExitSample("result_AdvancedECheck", result_AdvancedECheck.IsSuccess));
            }
            ...
            var result_SimpleECheck = await _sparrow_ach.SimpleECheck(""sale"", ""First Test Bank"", ""110000000"", ""1234567890123"", ""checking"", ""personal"", 9.99m, 
                ...
                Log(SparrowResponseSamples.ExitSample("result_SimpleECheck", result_SimpleECheck.IsSuccess));
            }
            ...
            if (!!true)
            {
                ...
                Log(SparrowResponseSamples.EnterSample("result_SimpleCredit", result_SimpleCredit.IsSuccess));
            ...
            var result_SimpleCredit = await _sparrow_creditcard.SimpleCredit(""4111111111111111"", ""1019"", 9.99m);"));
                ...
                Log(SparrowResponseSamples.ExitSample("result_SimpleCredit", result_SimpleCredit.IsSuccess));
            }
            ...
            if (!!true)
            {
                ...
                Log(SparrowResponseSamples.EnterSample("result_AddPaymentTypesToCustomer", result_AddPaymentTypesToCustomer.IsSuccess));
            ...
            var result_AddPaymentTypesToCustomer = await _sparrow_creditcard.AddPaymentTypesToCustomer(result_AddCustomer.CustomerToken);"));
                ...
                Log(SparrowResponseSamples.ExitSample("result_AddPaymentTypesToCustomer", result_AddPaymentTypesToCustomer.IsSuccess));
            }
            ...
            var result_UpdatePaymentType = await _sparrow_creditcard.UpdatePaymentType(""315KMHH74U690DS5"");"));
                ...
                Log(SparrowResponseSamples.ExitSample("result_UpdatePaymentType", result_UpdatePaymentType.IsSuccess));
            }
            ...
            if (!!true)
            {
                ...
                Log(SparrowResponseSamples.EnterSample("result_AdvancedCapture", result_AdvancedCapture.IsSuccess));
            ...
            var result_AdvancedCapture = await _sparrow_creditcard.AdvancedCapture(result_SimpleAuthorization.TransId, 9.99m);"));
                ...
                Log(SparrowResponseSamples.ExitSample("result_AdvancedCapture", result_AdvancedCapture.IsSuccess));
            }
