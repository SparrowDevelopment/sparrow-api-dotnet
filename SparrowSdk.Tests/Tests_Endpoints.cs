...
namespace SparrowSdk.Tests
{
    public partial class Tests
    {
        ...
        public async Task AddCreditCard()
        {
            ...
            TestContext.WriteLine(result_AddCreditCard.CreateRawLog("result_AddCreditCard"));

            // Assert.AreEqual(200, result_AddCreditCard.Status);
            // Assert.AreEqual(1, result_AddCreditCard.Response);
            Assert.IsTrue(result_AddCreditCard.TextResponse.ToUpper().Contains("SUCCESS"));
        }
        ...
        public async Task AddACH()
        {
            ...
            TestContext.WriteLine(result_AddACH.CreateRawLog("result_AddACH"));

            // Assert.AreEqual(200, result_AddACH.Status);
            // Assert.AreEqual(1, result_AddACH.Response);
            Assert.IsTrue(result_AddACH.TextResponse.ToUpper().Contains("SUCCESS"));
        }
        ...
        public async Task AddStarCard()
        {
            ...
            TestContext.WriteLine(result_AddStarCard.CreateRawLog("result_AddStarCard"));

            // Assert.AreEqual(200, result_AddStarCard.Status);
            // Assert.AreEqual(1, result_AddStarCard.Response);
            Assert.IsTrue(result_AddStarCard.TextResponse.ToUpper().Contains("SUCCESS"));
        }
        ...
        public async Task AddEwallet()
        {
            ...
            TestContext.WriteLine(result_AddEwallet.CreateRawLog("result_AddEwallet"));

            // Assert.AreEqual(200, result_AddEwallet.Status);
            // Assert.AreEqual(1, result_AddEwallet.Response);
            Assert.IsTrue(result_AddEwallet.TextResponse.ToUpper().Contains("SUCCESS"));
        }
        ...
        public async Task RetrieveInvoice()
        {
            ...
            // Assert.AreEqual(200, result_RetrieveInvoice.Status);
