...
namespace SparrowSdk.Tests
{
    public partial class Tests
    {
        ...
        {
            var result = await _sparrow_starcard.SimpleStarCard("4111111111111111", 9.99m, "52347800001");
        ...
        {
            var result = await _sparrow_starcard.AdvancedStarCard("4111111111111111", "1019", 9.99m, "52347800001");
        ...
        {
            var result = await _sparrow_starcard.AddStarCard("John", "Doe", "52347800001");
        ...
        {
            var result = await _sparrow_creditcard.RetrieveInvoice("Inv-39040");
        ...
        {
            var result = await _sparrow_creditcard.CancelInvoice("Inv-39040", "Testing");
        ...
        {
            var result = await _sparrow_creditcard.CancelInvoiceByCustomer("Inv-39040", "Testing");
        ...
        {
            var result = await _sparrow_creditcard.PayInvoiceWithCreditCard("Inv-39040", "4111111111111111", "1019");
        ...
        {
            var result = await _sparrow_creditcard.PayInvoiceWithBankAccount("Inv-39040", "First Test Bank", "110000000", "1234567890123", "checking", "personal");
